...
enum class Leathers(val id: Int, val leatherOptions: Array<LeatherItem>) {
    ...
    GREEN_DRAGON_LEATHER(id=Items.GREEN_DRAGON_LEATHER, leatherOptions = arrayOf(LeatherItem.GREEN_DHIDE_VAMBRACES, LeatherItem.GREEN_DHIDE_CHAPS, LeatherItem.GREEN_DHIDE_BODY)),
