...
enum class LeatherItem(val id: Int, val level: Int, val leatherCount: Int, val amount: Int = 1, val ticks: Int = 4, val craftXp: Double) {
    ...
    GREEN_DHIDE_VAMBRACES(id = Items.GREEN_DHIDE_VAMBRACES, leatherCount = 1, level = 57, craftXp = 62.0),
    ...
    BLUE_DHIDE_VAMBRACES(id = Items.BLUE_DHIDE_VAMBRACES, leatherCount = 1, level = 66, craftXp = 70.0),
    ...
    RED_DHIDE_VAMBRACES(id = Items.RED_DHIDE_VAMBRACES, leatherCount = 1, level = 73, craftXp = 78.0),
    ...
    BLACK_DHIDE_VAMBRACES(id = Items.BLACK_DHIDE_VAMBRACES, leatherCount = 1, level = 79, craftXp = 86.0),
