...
//        varbit = 607,
//        rune = Rune.AIR,
//        entrance = Tile(2841, 4830),
//        exit = Tile(2983, 3288)
//    ),
//    MIND(
//        ruins = intArrayOf(Objs.MYSTERIOUS_RUINS_29094, Objs.MYSTERIOUS_RUINS_29095),
//        altar = Objs.ALTAR_34761,
//        exitPortal = Objs.PORTAL_34749,
...
//    ),
//    WATER(
//        ruins = intArrayOf(Objs.MYSTERIOUS_RUINS_29096, Objs.MYSTERIOUS_RUINS_29097),
...
//        varbit = 609,
//        rune = Rune.WATER,
//        entrance = Tile(2725, 4832),
//        exit = Tile(3182, 3162)
//    ),
//    EARTH(
//        ruins = intArrayOf(Objs.MYSTERIOUS_RUINS_29098, Objs.MYSTERIOUS_RUINS_29099),
...
//    ),
//    FIRE(
//        ruins = intArrayOf(Objs.MYSTERIOUS_RUINS_30371, Objs.MYSTERIOUS_RUINS_30372),
...
//        varbit = 611,
//        rune = Rune.FIRE,
//        entrance = Tile(2576, 4848),
//        exit = Tile(3310, 3252)
//    ),
//    BODY(
//        ruins = intArrayOf(Objs.MYSTERIOUS_RUINS_30373, Objs.MYSTERIOUS_RUINS_31584),
...
//        varbit = 616,
//        rune = Rune.CHAOS,
//        entrance = Tile(2280, 4837),
//        exit = Tile(3060, 3585)
//    ),
//    ASTRAL(
//        altar = Objs.ALTAR_34771,
//        rune = Rune.ASTRAL
//    ),
//    NATURE(
//        ruins = intArrayOf(Objs.MYSTERIOUS_RUINS_32491, Objs.MYSTERIOUS_RUINS_32492),
...
//        varbit = 615,
//        rune = Rune.NATURE,
//        entrance = Tile(2400, 4835),
//        exit = Tile(2865, 3022)
//    ),
//    LAW(
//        ruins = intArrayOf(Objs.MYSTERIOUS_RUINS_32489, Objs.MYSTERIOUS_RUINS_32490),
...
//        varbit = 614,
//        rune = Rune.LAW,
//        entrance = Tile(2464, 4819),
//        exit = Tile(2858, 3378)
//    ),
//    DEATH(
//        ruins = intArrayOf(Objs.MYSTERIOUS_RUINS_34744, Objs.MYSTERIOUS_RUINS_34745),
...
//    ),
//    WRATH(
//        ruins = intArrayOf(Objs.MYSTERIOUS_RUINS_34746, Objs.MYSTERIOUS_RUINS_34747),
 ...
 * @author ...
 *
 * Vertegenwoordigt de verschillende Runecrafting-altars
 *
 * Ruins is nu voor alle altars hetzelfde object (Objs.MYSTERIOUS_RUINS).
 * De exit is overal gelijk, dus we hergebruiken één Tile.
 */
enum class Altar(
    // Het enkele `Mysterious Ruins` wordt in de plugin afgevangen via `commonRuin`
    val altar: Int,
    val exitPortal: Int? = null,
    val talisman: Int? = null,
    val tiara: Int? = null,
...
//        altar = Objs.ALTAR_34771,
//        rune = Rune.ASTRAL,
//        exit = Tile(2857, 3378) // bind-optie (geen talisman/tiara nodig)
//    ),
    NATURE(
        altar = Objs.ALTAR_34768,
        exitPortal = Objs.PORTAL_34756,
    ...
    BLOOD(
        altar = Objs.ALTAR_43479,
        exitPortal = Objs.PORTAL_43478,
        rune = Rune.BLOOD,
