...
arrayOf(Npcs.BOB_10619).forEach { shop ->
    ...
    on_npc_option(npc = shop, option = "repair") { open_shop(player) }
}

    suspend fun QueueTask.dialog() {
        chatNpc("Would you like to buy some tools?")
...
fun open_shop(p: Player) {
    p.openShop("Bobs Brilliant Tools")
}